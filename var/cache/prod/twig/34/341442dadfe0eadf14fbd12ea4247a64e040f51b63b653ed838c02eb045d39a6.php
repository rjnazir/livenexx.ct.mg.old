...
class __TwigTemplate_2acb6b457b737fdda7aff037db77cd1a0d2bbf4691a36a789fa0151eab1ca88c extends Twig_Template
{
    ...
    <div class=\"row\">
        ...
        echo "
                    ...
                    <div class=\"box-body\">
                        ";
        // line 31
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? null), "prvNom", array()), 'row');
        echo "
                        ";
        // line 32
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? null), "prvCode", array()), 'row');
        echo "
                    </div>
...
";
    ...
    {
        return new Twig_Source("", "AdminBundle:CtProvince:add.html.twig", "D:\\mydev\\livenexx.ct.mg\\src\\Ct\\BackOffice\\AdminBundle/Resources/views/CtProvince/add.html.twig");
    }
}
