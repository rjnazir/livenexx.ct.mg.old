...
class __TwigTemplate_4bea9de10a545e101da55324bba6e897be4d75078c0442f0667f5cde16d7257d extends Twig_Template
{
    ...
    <div class=\"row\">
        ...
        echo "
                    ...
                    <div class=\"box-body\">
                        ";
        // line 31
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? null), "gcLibelle", array()), 'row');
        echo "
                        ";
        // line 32
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? null), "gcIsCalculable", array()), 'row');
        echo "
                    </div>
...
";
    ...
    {
        return new Twig_Source("", "AdminBundle:CtGenreCategorie:add.html.twig", "D:\\mydev\\livenexx.ct.mg\\src\\Ct\\BackOffice\\AdminBundle/Resources/views/CtGenreCategorie/add.html.twig");
    }
}
