...
class __TwigTemplate_27075ce3078954fb3999bed6cb72b67a13ab5715a71556f1e0c20dbb0aad7893 extends Twig_Template
{
    ...
    <div class=\"row\">
        ...
        echo "
                    ...
                    <div class=\"box-body\">
                        ";
        // line 31
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? null), "pvType", array()), 'row');
        echo "
                        ";
        // line 32
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? null), "pvTarif", array()), 'row');
        echo "
                    </div>
...
";
    ...
    {
        return new Twig_Source("", "@Admin/CtProcesVerbal/add.html.twig", "D:\\mydev\\livenexx.ct.mg\\src\\Ct\\BackOffice\\AdminBundle\\Resources\\views\\CtProcesVerbal\\add.html.twig");
    }
}
